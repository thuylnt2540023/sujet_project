"""
Chart: Download time vs Number of Sources for test-medium.bin (5 MB)
...
CSV_PATH = "by_file/test-medium.csv"
...
fig.suptitle(
    "test-medium.bin (5 MB) -- Download Time vs Sources & Fragment Size",
    fontsize=14, fontweight="bold", y=1.02,
)

plt.tight_layout()
out = "test_medium_sources_vs_time.png"
