"""
Chart: Download time vs Number of Sources for
Acclaim & Response - The Godfather, Best Picture 1972.mkv (9.5 MB)
...
CSV_PATH = "by_file/Acclaim & Response - The Godfather, Best Picture 1972.csv"
...
# Drop the 10240 KB outlier (only 1 test)
df = df[df["frag_KB"] <= 2048]
...
fig.suptitle(
    "Acclaim & Response - The Godfather (9.5 MB) -- Download Time vs Sources & Fragment Size",
    fontsize=13, fontweight="bold", y=1.02,
)

plt.tight_layout()
out = "acclaim_sources_vs_time.png"
